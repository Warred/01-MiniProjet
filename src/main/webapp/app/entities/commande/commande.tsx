  ...
  return (
    <div>
      <h2 id="commande-heading">
        <Translate contentKey="commerceApp.commande.home.title">Commandes</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="commerceApp.commande.home.createLabel">Create new Commande</Translate>
        </Link>
      </h2>
        ...
        {commandeList && commandeList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="commerceApp.commande.home.notFound">No Commandes found</Translate>
            </div>
          )
        )}
      </div>
