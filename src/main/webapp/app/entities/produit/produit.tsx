  ...
  return (
    <div>
      <h2 id="produit-heading">
        <Translate contentKey="commerceApp.produit.home.title">Produits</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="commerceApp.produit.home.createLabel">Create new Produit</Translate>
        </Link>
      </h2>
        ...
        {produitList && produitList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('nom')}>
                  <Translate contentKey="commerceApp.produit.nom">Nom</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('prix')}>
                  <Translate contentKey="commerceApp.produit.prix">Prix</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="commerceApp.produit.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="commerceApp.produit.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="commerceApp.produit.home.notFound">No Produits found</Translate>
            </div>
          )
        )}
      </div>
